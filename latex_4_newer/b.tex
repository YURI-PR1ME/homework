...
\begin{titlepage}
        ...
        \begin{center}
            ...
            \vspace*{36pt}
            \fontsize{48pt}{0}{课\quad 程\quad 大\quad 作\quad 业}\\
            
            \vspace*{48pt}
            \LARGE（2025\~{}2026学年度\quad 第1学期）\\
            \vspace*{48pt}
            ...
            \Large 课程名称\ \ \underline{\makebox[200pt]{算法设计与分析}}\\
            \Large 作业名称\ \ \underline{\makebox[200pt]{面向多项式乘法问题的}}\\
\Large \qquad\qquad\quad \underline{\makebox[200pt]{快速傅里叶变换算法设计与分析}}\\
            \Large 学\qquad 院\ \ \underline{\makebox[200pt]{计算机与人工智能学院}}\\
            \Large 姓\qquad 名\ \ \underline{\makebox[200pt]{朱珠}}\\
            \Large 班\qquad 级\ \ \underline{\makebox[200pt]{大数据12301班}}\\
            \Large 学\qquad 号\ \ \underline{\makebox[200pt]{2304241202}}\\
            \Large 提交时间\ \ \underline{\makebox[200pt]{2025年11月19日}}\\
        \end{center}
    \end{titlepage}
...
\author{\IEEEauthorblockN{朱珠\textsuperscript{1*}
}\\
\IEEEauthorblockA{\textit{\textsuperscript{1} 计算机与人工智能学院, 武汉纺织大学, 武汉, 中国 } \\
\textsuperscript{*}学生邮箱: 2905708807@qq.com}
}
...
\begin{figure}[ht]
\centerline{\includegraphics[width=3.5in]{pictureC.png}}
...
\begin{figure}[ht]
\centerline{\includegraphics[width=3.5in]{pictureG.png}}
...
\begin{figure}[ht]
\centerline{\includegraphics[width=3.5in]{pictureH.png}}
...
\begin{figure}[ht]
\centerline{\includegraphics[width=3.5in]{pictureA.png}}
...
\begin{figure}[ht]
\centerline{\includegraphics[width=3.5in]{pictureB.png}}
...
\begin{figure}[ht]
\centerline{\includegraphics[width=3.5in]{pictureI.png}}
\caption{FFT演示}
\label{fig:fft_demo}
\end{figure}
